<script setup>
defineProps({
  variant: { type: String, default: "primary", validator: (v) => ["primary", "secondary", "danger", "ghost", "success", "warning"].includes(v) },
...
const variants = {
  ...
  secondary: "bg-white text-navy-700 border border-border hover:bg-surface focus:ring-navy-500",
  danger: "bg-danger text-white hover:bg-red-700 focus:ring-red-500",
  ghost: "text-navy-700 hover:bg-surface focus:ring-navy-500",
